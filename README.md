...
### [UFABC Gradient](https://github.com/RodrigoWitkowski/UFABC-Gradient)
...
`n8n` `Google Sheets` `ETL` `Google Cloud Credentials`
...
`n8n` `GitHub API` `Automation` `Cat as a service API`

## Tools and technologies

`Python` · `FastAPI` · `PostgreSQL` · `JavaScript` · `HTML` · `CSS` · `Git` · `n8n`


<!--CAT GIF START-->
![Daily cat](https://cataas.com/cat/LVxEssLs2D6pQaDy?position=center)
<!--CAT GIF END-->
